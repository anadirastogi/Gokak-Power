...
<!-- TemplateEndEditable -->
<link href="accomplishments.css" rel="stylesheet" type="text/css" />
</head>
...
/* 
        VIEW.PHP
        Displays all data from 'accomplishments' table
*/
	   ...
	   if(mysql_select_db("gpel",$connection)===FALSE)
        ...
        $result = mysql_query("SELECT * FROM accomplishments ORDER BY sysid desc") 
                or die(mysql_error());  
        ...
        echo "<tr> <th>ID</th> <th>heading</th> <th>accomplishments</th> <th></th> <th></th></tr>";
