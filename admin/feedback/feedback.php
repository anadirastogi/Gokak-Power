...
/* 
        VIEW.PHP
        Displays all data from 'feedback' table
*/
	   ...
	   if(mysql_select_db("gpel",$connection)===FALSE)
        ...
        $result = mysql_query("SELECT * FROM feedback ORDER BY sysid DESC") 
                or die(mysql_error());  
        ...
        echo "<tr> <th>ID</th> <th>name</th>  <th>emailid</th> <th>message</th> <th></th></tr>";
